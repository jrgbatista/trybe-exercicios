...
const population = [
  { name: 'Manaus', quantity: '2.02 milhões' },
  { name: 'Belém', quantity: '1.53 milhões' },
  { name: 'Porto Nacional', quantity: '53 mil' },
  { name: 'Lavras', quantity: '90 mil' },
  { name: 'Feira de Santana', quantity: '619 mil' },
  { name: 'Cascavel', quantity: '332 mil' },
  { name: 'Presidente Prudente', quantity: '231 mil' },
  { name: 'Touros', quantity: '33 mil' },
  { name: 'Jericoacoara', quantity: '20 mil' },
];
